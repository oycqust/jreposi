var SchedulerMgr = function() {
    ...
    exports.btnAdd = function () {
        $.fn.modalOpen({
            id: "jobDetailForm",
            title: '添加任务',
            url: projectName + '/plug-in/superui/pages/supermgr/JobDetailForm.html',
            width: "750px",
            height: "550px",
            callBack: function (iframeId) {
                top.frames[iframeId].AcceptClick();
    ...
    exports.loadGrid = function () {
        ...
        exports.options.$gridTable.jqGrid({
            datatype: "json",
            url:"/sop/plug-in/superui/content/supermgr/json/JobDetailGrid.json",
    ...
    exports.SearchEvent=function () {
        ...
        $("#gridTable").jqGrid('setGridParam', {
            url: "/plug-in/superui/content/supermgr/json/JobDetailGrid.json",
            postData: queryJson,
            page: 1
        }).trigger('reloadGrid');
    }
