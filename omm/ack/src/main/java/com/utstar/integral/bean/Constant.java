...
public class Constant
{
     ...
     * activity_${mediatype}_${activityid}_${duration}_${point}_${isZeroDel}_${limit}_${sysid}
     */
    public static final String MEDIACODE_FROM_CONFIG_FORMAT = "activity_%s_%s_%s_%s_%s_%s_%s";
    ...
    public static final String ACTI_ADD_LOCK = "acti_add_lock";
}
