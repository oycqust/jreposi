...
public class LoggerBuilder {
    ...
    private static Logger build(String name) {
        ...
        String fp = OptionHelper.substVars(LoggerBuilder.LOG_PATH + File.separator + name + "_%d{yyyyMMdd}.%i.log.zip",context);
        ...
        policy.setMaxFileSize(FileSize.valueOf("30MB"));
    ...
    public static void main(String[] args) {
        Logger logger = com.utstar.integral.log.LoggerBuilder.getLogger("1", "D:/logtest");
        String msg = "";
