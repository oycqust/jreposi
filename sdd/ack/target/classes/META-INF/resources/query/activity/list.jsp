  ...
  <body>
   <table id="ArbetTable">
    ...
    <div id="toolbar1" class="btn-group">
                                ...
                                <form id="addForm">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="limit" name="limit" placeholder="请填写参与上限(整数)">
                                    </div>
                                    <div class="form-group">
                                        <label for="point">积分</label>
                                        <input type="text" class="form-control" id="point" name="point" placeholder="请填写积分(整数)">
                                    </div>
                                    <div class="form-group">
        ...
        <!--  add modal end-->
        <!--   modal start-->
   <!--<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#ftpModal">Large modal</button>-->

           <div class="modal fade bs-example-modal-md" tabindex="-2" role="dialog" id="ftpModal" aria-labelledby="myLargeModalLabel9">
               <div class="modal-dialog modal-md" role="document">
                   <div class="modal-content" style="width: 80%;">
                       <div class="modal-header">
                           <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                           <h4 class="modal-title">ftp地址</h4>
                       </div>
                       <div class="modal-body">
                           <form>
                               <div class="form-group" style="display:block;">
                                   <label for="ftpLocation">ftp:</label>
                                   <input type="text" class="form-control" readonly id="ftpLocation" name="ftpLocation" value="dsfsd" style="display: inline-block;width: 50%;">
                                   <button class="btn btn-default copy-ftp" type="button">复制</button>
                               </div>
                               <div class="form-group"  style="display:block;">
                                   <label for="ftpName">用户名:</label>
                                   <input type="text" class="form-control" readonly id="ftpName" name="ftpLocation" value="dfdd" style="display: inline-block;width: 50%;">
                                   <button class="btn btn-default copy-ftp" type="button">复制</button>
                               </div>
                               <div class="form-group" style="display:block;">
                                   <label for="ftpPwd">密码:</label>
                                   <input type="text" class="form-control" readonly id="ftpPwd" name="ftpLocation" style="display: inline-block;width: 50%;">
                                   <button class="btn btn-default copy-ftp" type="button">复制</button>
                               </div>
                           </form>
                       </div>
   ...
   <script type = "text/javascript">
        $(function ()
        {
            ...
            oFileInput.Init("txt_file", "${pageContext.request.contextPath}/activity/excelInput");
             ...
             $("#ftpModal").on('shown.bs.modal', function (e){
                $(".copy-ftp").off('click').on('click', function(){
                                $(this).prev()[0].select();
            ...
            $.ajax(
                {
                    ...
                    success : function(data)
                    {
                        ...
                        {
                            $("#ftpModal").modal();
                            $("#ftpLocation").val(data.data.location);
                            $("#ftpName").val(data.data.username);
                            $("#ftpPwd").val(data.data.password);
                        }else{
