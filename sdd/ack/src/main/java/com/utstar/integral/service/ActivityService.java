...
public interface ActivityService {
     ...
     * @param username       用户名
     */
    void add(ActivityEntity activityEntity, String username) throws CoreException;
     ...
     * @param username       用户名
     */
    void del(List<String> ids, String username);
    ...
    void sycnActiTotalCode(String activityId, List<Map> medias, String viewKey);
