...
public class ActivityController {
    ...
    public Result getFtpUrl(){
        ...
        ftp.put("location", ftpLocation);
        ftp.put("username", ftpUsername);
        ftp.put("password", ftpPassword);
        result.setData(ftp);
        /*Result result = Result.SUCCESS;
        StringBuffer stringBuffer = new StringBuffer();
        int index = ftpLocation.indexOf("//");
        String prefix = ftpLocation.substring(0, index);
        stringBuffer.append(prefix).append(ftpUsername).
                append(":").append(ftpPassword).
                append("@").append(ftpLocation.substring(index, ftpLocation.length()));
