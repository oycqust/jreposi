...
public class TestApplicationContextInitializer implements ApplicationContextInitializer<ConfigurableApplicationContext>{
    ...
    public void initialize(ConfigurableApplicationContext applicationContext) {
        ...
        map.put("threadPool.corePoolSize","3");
        map.put("threadPool.maximumPoolSize","20");
        map.put("threadPool.keepAliveTime","3");
        map.put("threadPool.workQueue.capacity","15");
        map.put("cluster.master","true");

        map.put("acti.mediacode.sync.cron","0 0/20 * * * *");
        map.put("acti.mediacode.view.cron","0 0 3 * * *");
